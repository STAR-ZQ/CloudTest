...
public final class ExcelExportUtil {
    ...
    public static Workbook exportExcel(ExportParams entity, Class<?> pojoClass,
        ...
        new ExcelExportService().createSheet(workbook, entity, pojoClass, dataSet,null);
        return workbook;
    }
    ...
    public static Workbook exportExcel(List<Map<String, Object>> list, ExcelType type) {
        ...
        for (Map<String, Object> map : list) {
            ...
            service.createSheet(workbook, (ExportParams) map.get("title"),
                    (Class<?>) map.get("entity"), (Collection<?>) map.get("data"),(Map<Object,Object>)map.get("ignore"));
        }
        return workbook;
    }
    ...
    public static CellStyle exportStyle(Workbook workbook, int fontHeight,HorizontalAlignment align) {
     ...
     * @return 返回转换后的磅数
     */
    public static String kgOrPoundAndUnit(BigDecimal kg, String unit) {
        if (kg == null) return BigDecimal.ZERO.setScale(2, RoundingMode.HALF_UP) + unit;
        BigDecimal lb = new BigDecimal("2.20462262185");
        if ("kg".equals(unit)) return kg.setScale(2, RoundingMode.HALF_UP) + unit;
        return kg.multiply(lb).setScale(2, RoundingMode.HALF_UP) + unit;
    }
     ...
     * @return 返回转换后的磅数
     */
    public static BigDecimal kgOrPound(BigDecimal kg, String unit) {
        if (kg == null) return BigDecimal.ZERO.setScale(2, RoundingMode.HALF_UP);
        BigDecimal lb = new BigDecimal("2.20462262185");
        if ("kg".equals(unit)) return kg.setScale(2, RoundingMode.HALF_UP);
        return kg.multiply(lb).setScale(2, RoundingMode.HALF_UP);
    }
}
